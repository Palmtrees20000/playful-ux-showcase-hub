                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <Input
                      ...
                      className={`border-gray-200 focus:border-purple-400 ${errors.name ? 'border-red-500' : ''}`}
                      required
                      maxLength={100}
                    />
                  ...
                  <div>
                    <Input
                      ...
                      onChange={handleInputChange}
                      className={`border-gray-200 focus:border-purple-400 ${errors.email ? 'border-red-500' : ''}`}
                      required
                      maxLength={255}
                    />
                  ...
                  <div>
                    <Textarea
                      ...
                      onChange={handleInputChange}
                      className={`border-gray-200 focus:border-purple-400 min-h-[120px] ${errors.message ? 'border-red-500' : ''}`}
                      required
                      maxLength={1000}
                    />
